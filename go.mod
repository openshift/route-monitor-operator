...
require (
	...
	github.com/openshift/aws-vpce-operator v0.0.0-20260528002406-a08fc9e66955
	github.com/openshift/hypershift/api v0.0.0-20260527201923-0aa20fcc3847
	github.com/openshift/osde2e v0.0.0-20260519182900-eadad3d23611
