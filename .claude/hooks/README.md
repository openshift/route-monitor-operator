...
- High-risk security files (RBAC, auth)
...
- **golangci-lint**: Static analysis (gosec only per `.golangci.yaml`)
...
- Vendored code (`vendor/`)
- Boilerplate files (managed upstream)
- High-risk files (RBAC, auth, `.tekton/*.yaml`, Dockerfiles)
