...
func New(client client.Client, log logr.Logger, blackBoxImage string, blackBoxExporterNamespace string) *BlackBoxExporter {
	...
	return &BlackBoxExporter{client, log, blackBoxImage, blackboxNamespacedName}
}
