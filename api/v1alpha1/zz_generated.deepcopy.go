...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RawSloSpec) DeepCopyInto(out *RawSloSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RawSloSpec.
func (in *RawSloSpec) DeepCopy() *RawSloSpec {
	if in == nil {
		return nil
	}
	out := new(RawSloSpec)
